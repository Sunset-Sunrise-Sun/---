...
function makeLedTexture() {
  ...
  /* ⚠️ 这里的电话号码必须是**明显为空的占位号**，不能填现场照片里的真实号码。
     原因：这块屏的纹理是用 canvas 画的，图上的字能随镜头放大读到；
     而照片里的 LED 屏（board-hiring-led.jpg）已经按隐私原则打码了 ——
     三维这一份如果继续写真号码，等于把刚盖掉的信息又从三维里漏出去。
     占位号用 138-0000-00XX 这种一眼可辨的假号（真实运营商不会放这种号段）。 */
  const rows = [
    ['整件车位', '7000—10000', '莉翔制衣', '王师傅', '138-0000-0001', '4'],
    ['装拉链', '7000—10000', '莉翔制衣', '管师傅', '138-0000-0002', '1'],
    ['前后袋', '7000—10000', '莉翔制衣', '邹师傅', '138-0000-0003', '4'],
    ['车脚边', '7000—10000', '莉翔制衣', '王厂', '138-0000-0004', '2'],
    ['上腰', '7000—10000', '利玥服装', '刘师傅', '136-0000-0005', '1'],
    ['尾部杂工', '7000—10000', '利玥服装', '/', '137-0000-0006', '1']
  ];
  ...
  /* 底栏同样不写真实微信号（照片里那一行已打码，详见上方说明） */
  ctx.fillText('添加招工广场微信免费发布招工信息（微信号见现场公示）', 24, H - 24);
